/**
 *Class to test the string values of cards, I know the formatting is abysmal but i copied it from a python
 *script I made and copied the output for the terminal and pasted it herre since I didnt want to write
 *all the tests
 *
 *
 *@author Evan Jameson
